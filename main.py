...
class LowerThird(Scene):
    def construct(self):
        ...
        with register_font('fonts/Roboto-Regular.ttf'):
            title = Text('Anville Town', font="Roboto", height=abs_convert(60), fill_opacity=0).move_to(convert(-80, 900-30), aligned_edge=LEFT)

        with register_font('fonts/Roboto-Light.ttf'):
            subtitle = Text('Pokemon Black and White', font="Roboto", height=abs_convert(40), fill_opacity=0).move_to(convert(-80, 900+40), aligned_edge=LEFT)
